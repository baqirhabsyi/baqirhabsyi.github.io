...
import { BeritaList, CreateBerita, EditBerita } from './berita';
...
const App = () => (
    <Admin title="Admin Siskominfo Jadwal dan Kompen" restClient={RestClient(trackedResources, firebaseConfig)}>
        ...
        <Resource options={{ label: 'Daftar Berita' }} name="posts" list={BeritaList} create={CreateBerita} edit={EditBerita} remove={Delete} />
    </Admin>
);
